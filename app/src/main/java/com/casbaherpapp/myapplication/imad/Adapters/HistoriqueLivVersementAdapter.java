...
public class HistoriqueLivVersementAdapter extends RecyclerView.Adapter<HistoriqueLivVersementAdapter.ViewHolder> implements Filterable {
...
private ProgressLoaderListener progressLoaderListener;
    public HistoriqueLivVersementAdapter(Context context, FragmentManager fm, ArrayList<VersementItem> versementItems, int idLivreur, ProgressLoaderListener progressLoaderListener){
    ...
    @Override
    public HistoriqueLivVersementAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = mInflater.inflate(R.layout.historiqueversement_layout, parent, false);
        return new HistoriqueLivVersementAdapter.ViewHolder(view);
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull HistoriqueLivVersementAdapter.ViewHolder holder, int position) {
